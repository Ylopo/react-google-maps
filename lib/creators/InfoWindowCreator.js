...
var InfoWindowCreator = (function (_Component) {
  ...
  _createClass(InfoWindowCreator, [{
    ...
    key: "propTypes",
    value: {
      mapHolderRef: _propTypes2["default"].instanceOf(_GoogleMapHolder2["default"]).isRequired,
      infoWindow: _propTypes2["default"].object.isRequired,
      anchorHolderRef: _propTypes2["default"].object
    },
    enumerable: true
  }]);
